...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var btnModaAction = document.querySelector('.btn-modal-action');
  ...
  var form = document.querySelector('#form-deplacer');
  form.addEventListener('submit', function (event) {
    event.preventDefault();
    var btnInnerHtml = btnModaAction.innerHTML.trim();
    if (btnInnerHtml != 'déplacer') {
      window.location.href = "/celliers-ajouter";
    } else {
      var deplacerBouteille = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(quantite, cellierId, bouteilleId) {
          var response, data;
        ...
        return function deplacerBouteille(_x, _x2, _x3) {
          return _ref.apply(this, arguments);
        };
      }();
      var modifierQuantite = /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                id = card.id;
                url = "/bouteilles-listes-modifier/".concat(id);
        ...
        return function modifierQuantite() {
      ...
      var quantiteBouteille = card.querySelector('#quantite-bouteille').value;
      var idCellier = document.querySelector('#cellier-location').value;
  ...
  function afficherToastEtSauterNav(quantiteBouteille, toastLocation) {
    // Afficher le toast
    afficherToast("".concat(quantiteBouteille, " bouteille(s) d\xE9plac\xE9e(s) dans ").concat(toastLocation, "!"));
    modal.close();
