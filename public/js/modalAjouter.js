...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function _loadOptions() {
    _loadOptions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(type) {
      var response, data, cellier_id, cellierOrigine, optionElement;
  ...
  form.addEventListener('submit', function (event) {
    ...
    function _ajouterBouteille() {
      _ajouterBouteille = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(newQuantity, locationId, bouteilleId) {
        var response, toastLocation, data;
